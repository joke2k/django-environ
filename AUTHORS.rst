...
``django-environ`` was created by `Daniele Faraglia <https://github.com/joke2k>`_,
who is also the current maintainer.
`Serghei Iakovlev <https://github.com/sergeyklay/>`_ served as maintainer from
2021 to 2024.
